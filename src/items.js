export const items = [
    {
        id: 1,
        label: `15 полезных однострочных выражений JavaScript`,
        text: `Улучшение JavaScript-кода за пару минут перевод 15 Helpful JavaScript One-Liners`,
    },

    {
        id: 2,
        label: `Полиморфизм простыми словами`,
    ...
    {
        id: 11,
        label: `Девшахта-подкаст`,
        text: `#108: Производительность кода — это важнейший критерий качества?`,
    },
    {
        id: 12,
        label: `Одна из самых красивых идей в информатике: Y-Combinator`,
